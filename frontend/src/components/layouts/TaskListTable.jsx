        ...
        <tbody>
          {tableData.map((task) => (
            <tr key={task._id} className="border-t border-gray-200">
              <td className="py-3 px-4 text-gray-700 text-[13px] line-clamp-1">{task.title}</td>
              ...
              <td className="px-4 py-3 text-gray-700 text-[13px] hidden md:table-cell">
                {task.createdAt ? moment(task.createdAt).format("Do MMMM YYYY") : "N/A"}
              </td>
            </tr>
          ))}
        </tbody>
