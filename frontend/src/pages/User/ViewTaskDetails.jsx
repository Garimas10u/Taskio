        ...
        {task && (
          ...
          <div className='form-card col-span-3'>
            <div className='flex items-center justify-between'>
              ...
              <div className={`text-[13px] font-medium ${getStatusTagColor(task?.status)} px-4 py-0.5 rounded-md`}>{task?.status}</div>
            </div>
            ...
            <div className="grid grid-cols-12 gap-4 mt-4">
              ...
              <div className='col-span-6 md:col-span-4'>
                <InfoBox  label="Due Date" value={task?.dueDate? moment(task?.dueDate).format("Do MM YYYY") : "N/A" } />
              </div>
              <div className='col-span-6 md:col-span-4'>
...
const Attachment = ({ link, index, onClick }) => {
  return <div className='flex justify-between bg-gray-50 border  border-gray-100 px-3 py-2 rouned-md cursor-pointer mb-3 mt-2' onClick={onClick}>
