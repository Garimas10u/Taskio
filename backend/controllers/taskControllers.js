...
const createTask = async(req, res)=>{
    try{
       ...
       const task = await Task.create ({
        title, description, priority, dueDate, assignedTo, createdBy: req.user._id,
...
module.exports = {
    getTasks, getTaskById, createTask, getDashboardData, getUserDashboardData, deleteTask, updateTaskStatus, updateTaskChecklist, updateTask
}